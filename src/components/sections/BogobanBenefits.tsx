...
import { ForCoachesTherapistsBogoban } from './ForCoachesTherapistsBogoban';

interface BogobanBenefitsProps {
  className?: string;
}

const BogobanBenefits: React.FC<BogobanBenefitsProps> = ({ className }) => {
  ...
  return (
    <>
      ...
      <ForCoachesTherapistsBogoban />
    </>
  );
};

export { BogobanBenefits };
