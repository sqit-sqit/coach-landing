...
interface ForCoachesTherapistsBogobanProps {
  className?: string;
}

const ForCoachesTherapistsBogoban: React.FC<ForCoachesTherapistsBogobanProps> = ({ className }) => {
    ...
    <section id="for-coaches-therapists" className={cn(
      ...
      <div className="w-full max-w-[1110px] mx-auto px-4 md:px-8 lg:px-0">
        ...
        <div className="w-full max-w-[350px] h-auto min-h-[400px] md:min-h-[500px] lg:min-h-[542px] flex flex-col justify-start items-stretch gap-6 p-4 md:p-6 lg:p-[34px] rounded-[20px] bg-[#fcf9f1]">
          ...
          {/* Description */}
          <p className="h-auto self-stretch flex font-montserrat text-base leading-[1.5] text-left text-[#333] mb-2">
...
export { ForCoachesTherapistsBogoban };
